  ...
  'targets': [
    ...
    },
    {
      ...
      'copies': [
        ...
        {
          'destination': '<(PRODUCT_DIR)/chromium_l10n',
          'files': [
    ...
    },
    {
      ...
      'sources': [
        ...
        'browser/oxide_cookie_store_proxy.cc',
        'browser/oxide_cookie_store_proxy.h',
        ...
        'browser/oxide_web_popup_menu_client.h',
        'browser/oxide_web_popup_menu_impl.cc',
        'browser/oxide_web_popup_menu_impl.h',
