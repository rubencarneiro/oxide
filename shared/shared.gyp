  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        'browser/permissions/oxide_permission_request_id.cc',
        'browser/permissions/oxide_permission_request_id.h',
      ...
      'conditions': [
        ['enable_plugins==1', {
          'sources': [
            ...
            'browser/oxide_pepper_flash_browser_host.cc',
            'browser/oxide_pepper_flash_browser_host.h',
            'renderer/oxide_pepper_renderer_host_factory.cc',
            'renderer/oxide_pepper_renderer_host_factory.h',
            'renderer/oxide_pepper_render_frame_observer.cc',
            'renderer/oxide_pepper_render_frame_observer.h',
            'renderer/oxide_pepper_flash_renderer_host.cc',
            'renderer/oxide_pepper_flash_renderer_host.h',
            'renderer/oxide_pepper_flash_menu_host.cc',
            'renderer/oxide_pepper_flash_menu_host.h',
            'renderer/oxide_pepper_shared_memory_message_filter.cc',
            'renderer/oxide_pepper_shared_memory_message_filter.h',
          ],
          'dependencies': [
