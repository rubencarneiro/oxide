...
#ifndef OXIDE_QTQUICK_WEB_VIEW
#define OXIDE_QTQUICK_WEB_VIEW
...
class OXIDE_QTQUICK_EXPORT OxideQQuickWebView : public QQuickItem {
  Q_OBJECT
 ...
 public:
  ...
  ~OxideQQuickWebView() Q_DECL_OVERRIDE;
