...
#ifndef _OXIDE_QT_CORE_API_NETWORK_CALLBACK_EVENTS_P_P_H_
#define _OXIDE_QT_CORE_API_NETWORK_CALLBACK_EVENTS_P_P_H_
...
#endif // _OXIDE_QT_CORE_API_NETWORK_CALLBACK_EVENTS_P_P_H_
