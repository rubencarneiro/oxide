...
#ifndef _OXIDE_QT_LIB_API_PRIVATE_Q_USER_SCRIPT_P_H_
#define _OXIDE_QT_LIB_API_PRIVATE_Q_USER_SCRIPT_P_H_
...
#endif // _OXIDE_QT_LIB_API_PRIVATE_Q_USER_SCRIPT_P_H
