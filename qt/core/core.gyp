  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        '../quick/api/private/oxideqquickoutgoingmessagerequest_p.cc',
        '../quick/api/oxideqquickoutgoingmessagerequest_p_p.h',
        '../quick/api/private/oxideqquickuserscript_p.cc',
        '../quick/api/oxideqquickuserscript_p_p.h',
        '../quick/api/private/oxideqquickwebcontext_p.cc',
        '../quick/api/oxideqquickwebcontext_p_p.h',
        '../quick/api/private/oxideqquickwebframe_p.cc',
    ...
    },
    {
      ...
      'sources': [
        ...
        '../quick/api/private/oxideqquickmessagehandler_p.cc',
