  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'browser/oxide_qt_touch_handle_drawable_delegate.cc',
        'browser/oxide_qt_touch_handle_drawable_delegate.h',
        ...
        'glue/oxide_qt_touch_handle_drawable_delegate_proxy.h',
