...
#ifndef _OXIDE_QT_LIB_API_PUBLIC_Q_WEB_FRAME_BASE_H_
#define _OXIDE_QT_LIB_API_PUBLIC_Q_WEB_FRAME_BASE_H_
...
#endif // _OXIDE_QT_LIB_API_PUBLIC_Q_WEB_FRAME_BASE_H_
