...
#ifndef _OXIDE_QT_LIB_API_QQUICK_OUTGOING_MESSAGE_REQUEST_P_H_
#define _OXIDE_QT_LIB_API_QQUICK_OUTGOING_MESSAGE_REQUEST_P_H_
...
#endif // _OXIDE_QT_LIB_API_QQUICK_OUTGOING_MESSAGE_REQUEST_P_H_
