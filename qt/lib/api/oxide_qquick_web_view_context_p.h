...
#ifndef _OXIDE_QT_LIB_API_QQUICK_WEB_VIEW_CONTEXT_P_H_
#define _OXIDE_QT_LIB_API_QQUICK_WEB_VIEW_CONTEXT_P_H_
...
#endif // _OXIDE_QT_LIB_API_QQUICK_WEB_VIEW_CONTEXT_P_H_
