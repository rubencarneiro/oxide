...
if(DEFINED _Oxide_LibUtils_INCLUDED_)
  return()
endif()
set(_Oxide_LibUtils_INCLUDED_ TRUE)
...
macro(calculate_versioned_library_suffix _out _version)
  if(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
    set(${_out} ${CMAKE_SHARED_LIBRARY_SUFFIX}.${_version})
  else()
    message(FATAL_ERROR "calculate_versioned_library_suffix is not implemented for this platform")
  endif()
endmacro()
