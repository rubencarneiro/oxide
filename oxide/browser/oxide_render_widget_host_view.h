...
#ifndef _OXIDE_BROWSER_RENDER_WIDGET_HOST_VIEW_H_
#define _OXIDE_BROWSER_RENDER_WIDGET_HOST_VIEW_H_
...
class OXIDE_CORE_EXPORT RenderWidgetHostView :
...
#endif // _OXIDE_BROWSER_RENDER_WIDGET_HOST_VIEW_H_
